...
class HeapCanvas:
    ...
    def detach_listeners(self) -> None:
        ...
        this canvas is being replaced (e.g. presentation-mode zoom in the
        host app), so a previous renderer's now-destroyed widget doesn't
        keep getting notified alongside the new one."""
